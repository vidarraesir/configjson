...
// =============================================================
// VOCABULARIO DE ARTÍCULOS (mazos escalables, con ucraniano)
// Cada entrada: { id, emoji, titulo, cards:[{palabra, traduccion}] }
// Los 3 primeros reutilizan themedVocab; el resto son artículos nuevos.
// Se añaden con push() para poder ampliar la lista fácilmente.
// =============================================================

window.DELE_DATA.articleDecks = [
  { id: 'psico', emoji: '🧠', titulo: 'Psicología y relaciones', cards: window.DELE_DATA.themedVocab.psicologia },
  { id: 'intel', emoji: '✨', titulo: 'Inteligencias múltiples', cards: window.DELE_DATA.themedVocab.inteligencias },
  { id: 'salud', emoji: '💊', titulo: 'Salud y sueño', cards: window.DELE_DATA.themedVocab.saludSueno }
];

window.DELE_DATA.articleDecks.push({ id: 'insectos', emoji: '🦗', titulo: 'Insectos comestibles', cards: [
  { palabra: `Contar con`, traduccion: `мати, володіти чимось` },
  { palabra: `Un alto valor proteico`, traduccion: `висока білкова цінність` },
  { palabra: `Producción a gran escala`, traduccion: `великомасштабне виробництво` },
  { palabra: `Con creces`, traduccion: `з надлишком, більш ніж достатньо` },
  { palabra: `Dar el visto bueno`, traduccion: `дати згоду, схвалити` },
  { palabra: `Ganar adeptos`, traduccion: `набувати прихильників` },
  { palabra: `La cría`, traduccion: `розведення` },
  { palabra: `Lo tienen todo para`, traduccion: `мають усе, щоб` },
  { palabra: `El superalimento del futuro`, traduccion: `суперїжа майбутнього` },
  { palabra: `Aprovechamiento nutritivo`, traduccion: `ефективне засвоєння поживних речовин` },
  { palabra: `El aumento incesante de la población mundial`, traduccion: `безперервне зростання населення світу` },
  { palabra: `Cambiar de hábitos alimentarios`, traduccion: `змінювати харчові звички` },
  { palabra: `Acumular grasas saturadas`, traduccion: `накопичувати насичені жири` },
  { palabra: `Ser rico en micronutrientes`, traduccion: `бути багатим на мікронутрієнти` },
  { palabra: `El hierro`, traduccion: `залізо` },
  { palabra: `El cobre`, traduccion: `мідь` },
  { palabra: `El magnesio`, traduccion: `магній` },
  { palabra: `La fibra`, traduccion: `клітковина` },
  { palabra: `Lo que redunda en importantes beneficios para la salud`, traduccion: `що приносить значну користь для здоров'я` },
  { palabra: `Hacer un símil`, traduccion: `проводити аналогію` },
  { palabra: `Aberración`, traduccion: `абсурд, викривлення, щось неприродне` },
  { palabra: `Un control exhaustivo`, traduccion: `ретельний контроль` },
  { palabra: `El grillo`, traduccion: `цвіркун` },
  { palabra: `La ganadería tradicional`, traduccion: `традиційне тваринництво` },
  { palabra: `Cultivo vertical`, traduccion: `вертикальне вирощування` },
  { palabra: `Ser viable`, traduccion: `бути життєздатним, можливим` },
  { palabra: `Piscifactorías`, traduccion: `рибні ферми` },
  { palabra: `Aportar valor nutricional`, traduccion: `забезпечувати поживну цінність` },
  { palabra: `Omnívoros`, traduccion: `всеїдні` },
  { palabra: `Dar suelta a la investigación científica`, traduccion: `дати поштовх науковим дослідженням` },
  { palabra: `Coadyuvante`, traduccion: `допоміжний, супровідний чинник` },
  { palabra: `Poner a prueba toda la industria alimentaria`, traduccion: `поставити під випробування всю харчову промисловість` },
  { palabra: `Dar luz verde`, traduccion: `дати зелене світло, схвалити` },
  { palabra: `Larva del gusano de la harina`, traduccion: `личинка борошняного хрущака` },
  { palabra: `Langosta migratoria`, traduccion: `перелітна сарана` },
  { palabra: `Grillo doméstico`, traduccion: `домашній цвіркун` },
  { palabra: `Larvas de escarabajo`, traduccion: `личинки жуків` }
]});

window.DELE_DATA.articleDecks.push({ id: 'ruido', emoji: '🎧', titulo: 'Contaminación acústica', cards: [
  { palabra: `La contaminación acústica`, traduccion: `шумове забруднення` },
  { palabra: `Reducir el impacto`, traduccion: `зменшити вплив` },
  { palabra: `Una amenaza invisible`, traduccion: `невидима загроза` },
  { palabra: `Efectos perjudiciales`, traduccion: `шкідливі наслідки` },
  { palabra: `Los seres vivos`, traduccion: `живі істоти` },
  { palabra: `Las muertes prematuras`, traduccion: `передчасні смерті` },
  { palabra: `Las estimaciones globales`, traduccion: `глобальні оцінки` },
  { palabra: `Tener un gran peso`, traduccion: `мати велике значення` },
  { palabra: `Las enfermedades cardiovasculares`, traduccion: `серцево-судинні захворювання` },
  { palabra: `Es un factor desencadenante`, traduccion: `є провокуючим фактором` },
  { palabra: `Potenciar los riesgos`, traduccion: `підвищувати ризики` },
  { palabra: `Los efectos adversos`, traduccion: `несприятливі наслідки` },
  { palabra: `Perturbar`, traduccion: `порушувати / турбувати` },
  { palabra: `Contribuir a`, traduccion: `сприяти` },
  { palabra: `Exposición prolongada`, traduccion: `тривалий вплив` },
  { palabra: `Elevar la presión arterial`, traduccion: `підвищувать артеріальний тиск` },
  { palabra: `Favorecer el daño vascular`, traduccion: `сприяти ушкодженню судин` },
  { palabra: `Patologías`, traduccion: `патології` },
  { palabra: `Fragmentación del sueño`, traduccion: `фрагментація сну / порушення структури сну` },
  { palabra: `Acumulación de grasa corporal`, traduccion: `накопичення жирової маси` },
  { palabra: `Optar por alternativas`, traduccion: `обирати альтернативи` },
  { palabra: `La contaminación auditiva`, traduccion: `шумове забруднення` },
  { palabra: `Los focos de ruido`, traduccion: `джерела шуму` }
]});

window.DELE_DATA.articleDecks.push({ id: 'ia', emoji: '💻', titulo: 'Inteligencia artificial y energía', cards: [
  { palabra: `La IA (inteligencia artificial)`, traduccion: `штучний інтелект` },
  { palabra: `Voraz consumo de energía`, traduccion: `ненаситне споживання енергії` },
  { palabra: `Atentar contra`, traduccion: `завдавати шкоди / посягати на` },
  { palabra: `No hay final a la vista`, traduccion: `не видно кінця` },
  { palabra: `Girar en torno a`, traduccion: `обертатися навколо` },
  { palabra: `Exagerar`, traduccion: `перебільшувати` },
  { palabra: `Rueda de prensa`, traduccion: `пресконференція` },
  { palabra: `Proporcionar mejoras`, traduccion: `забезпечувати покращення` },
  { palabra: `Eficiencia`, traduccion: `ефективність` },
  { palabra: `Compensar con creces`, traduccion: `з лишком компенсувати` },
  { palabra: `Asombroso auge`, traduccion: `вражаюче зростання` },
  { palabra: `Estar en el auge`, traduccion: `бути на піку (розвитку / популярності)` },
  { palabra: `Combatir el cambio climático`, traduccion: `боротися зі зміною клімату` },
  { palabra: `Llegar a una conclusión`, traduccion: `дійти висновку` },
  { palabra: `Tener un profundo impacto`, traduccion: `мати глибокий вплив` },
  { palabra: `Demanda de energía`, traduccion: `попит на енергію` },
  { palabra: `Consumir electricidad`, traduccion: `споживати електроенергію` },
  { palabra: `Estar por las nubes`, traduccion: `бути захмарно високим` },
  { palabra: `Monitorear`, traduccion: `відстежувати / моніторити` },
  { palabra: `Sede`, traduccion: `штаб-квартира` },
  { palabra: `Saturar la red`, traduccion: `перевантажувати мережу` },
  { palabra: `Revelar`, traduccion: `розкривати / виявляти` },
  { palabra: `Despliegue masivo de recursos adicionales`, traduccion: `масове розгортання додаткових ресурсів` },
  { palabra: `Los gigantes tecnológicos se afanan por controlar su consumo de energía`, traduccion: `технологічні гіганти всіляко намагаються контролювати своє споживання енергії` },
  { palabra: `Estar a la vanguardia`, traduccion: `бути на передовій` },
  { palabra: `Las emisiones se dispararon`, traduccion: `викиди різко зросли` },
  { palabra: `Ser crucial`, traduccion: `бути ключовим` },
  { palabra: `Reducir la huella de carbono`, traduccion: `зменшувати вуглецевий слід` },
  { palabra: `Suministrar energía limpia`, traduccion: `постачати чисту енергію` },
  { palabra: `Satisfacer la demanda`, traduccion: `задовольняти попит` },
  { palabra: `Gasoductos`, traduccion: `газопроводи` },
  { palabra: `Los centros de datos son más perjudiciales que beneficiosos para el clima`, traduccion: `центри обробки даних більше шкодять клімату, ніж приносять користь` }
]});

window.DELE_DATA.articleDecks.push({ id: 'cronotipos', emoji: '😴', titulo: 'Cronotipos y sueño', cards: [
  { palabra: `Alondra (los madrugadores)`, traduccion: `жайворонок (людина, яка рано встає)` },
  { palabra: `Colibrí (personas de ritmos no tan definidos)`, traduccion: `колібрі (люди з нерегулярними ритмами)` },
  { palabra: `Búho (los noctámbulos)`, traduccion: `сова (нічна людина)` },
  { palabra: `Los cronotipos`, traduccion: `хронотипи` },
  { palabra: `Saber a la perfección`, traduccion: `знати досконало` },
  { palabra: `Los ritmos circadianos`, traduccion: `циркадні ритми` },
  { palabra: `La alternancia entre día y noche`, traduccion: `чергування дня і ночі` },
  { palabra: `Se (me/te/le) pegan las sábanas`, traduccion: `проспати, "не відірватися від ліжка"` },
  { palabra: `La retina`, traduccion: `сітківка` },
  { palabra: `El estímulo lumínico`, traduccion: `світловий стимул` },
  { palabra: `La secreción de melatonina`, traduccion: `виділення мелатоніну` },
  { palabra: `Viceversa`, traduccion: `навпаки` },
  { palabra: `Muchas personas se identifican con...`, traduccion: `багато людей впізнають себе в` },
  { palabra: `Dificultades para rendir en su día a día`, traduccion: `труднощі із продуктивністю в повсякденному житті` },
  { palabra: `Los cronotipos vienen dados...`, traduccion: `типи хронотипів зумовлені` },
  { palabra: `La glándula pineal`, traduccion: `шишкоподібна залоза` },
  { palabra: `Variar`, traduccion: `змінюватися` },
  { palabra: `Las personas tienden a acostarse pronto`, traduccion: `люди схильні лягати рано` },
  { palabra: `El ritmo vital`, traduccion: `життєвий ритм` },
  { palabra: `Diurnos`, traduccion: `денні (люди)` },
  { palabra: `Trasnochar`, traduccion: `не спати допізна, засиджуватися до ночі` },
  { palabra: `Las personas vespertinas`, traduccion: `люди, активні ввечері` },
  { palabra: `Inconformistas`, traduccion: `нонконформісти` },
  { palabra: `Sería un auténtico suplicio`, traduccion: `це було б справжнім випробуванням/мукою` },
  { palabra: `Desajuste en ritmos hormonales`, traduccion: `порушення гормональних ритмів` },
  { palabra: `Sueño no reparador`, traduccion: `сон, що не відновлює` },
  { palabra: `Entender tu energía va más allá del cronotipo`, traduccion: `розуміння своєї енергії виходить за межі хронотипу` },
  { palabra: `Formar parte de`, traduccion: `бути частиною` },
  { palabra: `La longevidad`, traduccion: `довголіття` },
  { palabra: `La hipoxia intermitente`, traduccion: `інтермітуюча гіпоксія (стан, коли організм періодично отримує менше кисню, ніж потрібно)` },
  { palabra: `La fatiga`, traduccion: `втома` },
  { palabra: `El bajo rendimiento`, traduccion: `низька продуктивність` },
  { palabra: `La falta de recuperación`, traduccion: `відсутність відновлення` }
]});

window.DELE_DATA.articleDecks.push({ id: 'espacial', emoji: '🚀', titulo: 'Misión espacial a la Luna', cards: [
  { palabra: `Convertirse en`, traduccion: `стають / перетворюються на` },
  { palabra: `La tripulación`, traduccion: `екіпаж` },
  { palabra: `Batir el récord (batir)`, traduccion: `побити рекорд` },
  { palabra: `La tripulación recorrió (recorrer)`, traduccion: `екіпаж подолав` },
  { palabra: `Una vista realmente majestuosa`, traduccion: `справді величний краєвид` },
  { palabra: `El lanzamiento de la misión`, traduccion: `запуск місії` },
  { palabra: `Brindar un vínculo reconfortante con su hogar`, traduccion: `дати відчуття зв'язку з домом` },
  { palabra: `La comunicación bidireccional`, traduccion: `двосторонній зв'язок` },
  { palabra: `La nave espacial`, traduccion: `космічний корабель` },
  { palabra: `Llegó una ráfaga de datos`, traduccion: `надійшов потік даних` },
  { palabra: `El alivio`, traduccion: `полегшення` },
  { palabra: `La nave tuvo que valerse por sí misma`, traduccion: `корабель змушений був діяти самостійно` },
  { palabra: `Realizar una maniobra`, traduccion: `виконати маневр` },
  { palabra: `El apagón`, traduccion: `відключення / збій зв'язку` },
  { palabra: `La telemetría`, traduccion: `телеметрія (дистанційний контроль через дані)` },
  { palabra: `Las primeras imágenes preliminares`, traduccion: `перші попередні зображення` },
  { palabra: `El hemisferio oculto`, traduccion: `прихована півкуля` },
  { palabra: `La superficie lunar`, traduccion: `поверхня Місяця` },
  { palabra: `Rastrear`, traduccion: `відстежувати` },
  { palabra: `Intensificar la exploración`, traduccion: `посилювати дослідження` },
  { palabra: `Una presencia sostenible`, traduccion: `стала присутність` },
  { palabra: `Lanzar una red de satélites`, traduccion: `запустити мережу супутників` }
]});

window.DELE_DATA.articleDecks.push({ id: 'espionaje', emoji: '🕵️', titulo: 'Espionaje (el topo)', cards: [
  { palabra: `El topo`, traduccion: `кріт (таємний агент, «внутрішній шпигун»)` },
  { palabra: `Estar en el corazón de`, traduccion: `бути в самому центрі` },
  { palabra: `La CIA (Agencia Central de Inteligencia)`, traduccion: `ЦРУ (Центральне розвідувальне управління)` },
  { palabra: `Ser clave para`, traduccion: `бути ключовим для` },
  { palabra: `El espía`, traduccion: `шпигун` },
  { palabra: `Recabar información`, traduccion: `збирати інформацію` },
  { palabra: `Líder chavista`, traduccion: `чавістський лідер (прибічник ідеології та курсу Уго Чавеса, «соціалізму XXI століття»)` },
  { palabra: `La operación militar`, traduccion: `військова операція` },
  { palabra: `La invasión`, traduccion: `вторгнення` },
  { palabra: `Unidad de élite`, traduccion: `елітний підрозділ` },
  { palabra: `Ejecutar operaciones`, traduccion: `проводити / здійснювати операції` },
  { palabra: `Salir adelante`, traduccion: `впоратися, вижити, досягти успіху` },
  { palabra: `Agentes infiltrados`, traduccion: `впроваджені агенти` },
  { palabra: `Resultar decisivo`, traduccion: `виявитися вирішальним` },
  { palabra: `Capturar a alguien`, traduccion: `захопити когось` },
  { palabra: `Una habitación blindada`, traduccion: `броньована кімната / захищене приміщення` },
  { palabra: `Intrusiones`, traduccion: `вторгнення, несанкціоновані проникнення` },
  { palabra: `La acusación`, traduccion: `обвинувачення` },
  { palabra: `La fiscal general de Estados Unidos`, traduccion: `Генеральна прокурорка США` },
  { palabra: `De forma encubierta`, traduccion: `приховано, таємно` },
  { palabra: `Tejer contactos`, traduccion: `налагоджувати контакти` },
  { palabra: `Los agentes de campo`, traduccion: `польові агенти` },
  { palabra: `Un preciado activo`, traduccion: `цінний актив` },
  { palabra: `Facilitar información`, traduccion: `надавати інформацію` },
  { palabra: `Rastrear los movimientos`, traduccion: `відстежувати переміщення` },
  { palabra: `Conducir a la detención`, traduccion: `призвести до затримання` },
  { palabra: `Organizaciones delictivas`, traduccion: `злочинні організації` },
  { palabra: `Una amenaza`, traduccion: `загроза` },
  { palabra: `A la postre`, traduccion: `зрештою, в підсумку` },
  { palabra: `La recompensa`, traduccion: `винагорода` },
  { palabra: `Apresurarse`, traduccion: `квапитися` },
  { palabra: `Establecer patrones`, traduccion: `встановлювати закономірності` },
  { palabra: `Recopilar datos`, traduccion: `збирати дані` },
  { palabra: `Guardia pretoriana`, traduccion: `преторіанська гвардія (вірна, привілейована охорона чи оточення лідера)` },
  { palabra: `Guardaespaldas`, traduccion: `охоронці / тілоохоронці` },
  { palabra: `Anticipar`, traduccion: `передбачати` },
  { palabra: `La rueda de prensa`, traduccion: `пресконференція` },
  { palabra: `Intervención militar`, traduccion: `військове втручання` },
  { palabra: `En suelo de`, traduccion: `на території (країни)` },
  { palabra: `Las lanchas surcaban las aguas del mar Caribe`, traduccion: `катери борознили води Карибського моря` },
  { palabra: `Aval`, traduccion: `схвалення, гарантія` },
  { palabra: `Ser patente`, traduccion: `бути очевидним` },
  { palabra: `Muelle de carga`, traduccion: `вантажний причал` },
  { palabra: `Campaña de presión sobre el país`, traduccion: `кампанія тиску на країну` },
  { palabra: `Destitución del presidente`, traduccion: `усунення президента з посади` },
  { palabra: `Almacenar los alijos de droga`, traduccion: `зберігати партії наркотиків` },
  { palabra: `Dispuesto a`, traduccion: `готовий до / налаштований на` }
]});

window.DELE_DATA.articleDecks.push({ id: 'bienestar', emoji: '🧘', titulo: 'Industrias del bienestar', cards: [
  { palabra: `El volumen económico`, traduccion: `економічний обсяг` },
  { palabra: `Las industrias de desarrollo personal`, traduccion: `індустрії особистісного розвитку` },
  { palabra: `Ir en aumento`, traduccion: `зростати` },
  { palabra: `No tener previsión de`, traduccion: `не мати прогнозу щодо` },
  { palabra: `Estar ligado a`, traduccion: `бути пов'язаним із` },
  { palabra: `Seguir una tendencia al alza`, traduccion: `продовжувати висхідну тенденцію` },
  { palabra: `Algo no cuadra`, traduccion: `щось не сходиться` },
  { palabra: `Retocar`, traduccion: `підправляти, коригувати` },
  { palabra: `Encaminado a`, traduccion: `спрямований на` },
  { palabra: `Inundar`, traduccion: `заполоняти, наводнювати` },
  { palabra: `Se prevé`, traduccion: `прогнозується` },
  { palabra: `La tasa de crecimiento`, traduccion: `темп зростання` },
  { palabra: `Ir de la mano de`, traduccion: `йти пліч-о-пліч з` },
  { palabra: `Más bien`, traduccion: `радше, скоріше` },
  { palabra: `Los ansiolíticos`, traduccion: `анксіолітики (протитривожні препарати)` },
  { palabra: `Los sedantes`, traduccion: `седативні засоби (заспокійливі)` },
  { palabra: `Precoz`, traduccion: `передчасний, ранній` },
  { palabra: `Peculiar`, traduccion: `своєрідний, особливий` },
  { palabra: `Los opiáceos`, traduccion: `опіоїди` },
  { palabra: `Estar ante un problema`, traduccion: `стикатися з проблемою` },
  { palabra: `La panacea`, traduccion: `панацея` },
  { palabra: `Tender a`, traduccion: `мати схильність до` },
  { palabra: `Echar la mirada atrás`, traduccion: `озиратися назад` },
  { palabra: `Detectar`, traduccion: `виявляти` },
  { palabra: `Albergar`, traduccion: `містити, плекати, таїти` },
  { palabra: `El culto a`, traduccion: `культ (чогось)` },
  { palabra: `Desbordar`, traduccion: `виходити за межі, переповнювати` },
  { palabra: `Vivir hiperalerta`, traduccion: `жити в стані гіперпильності` },
  { palabra: `Bajones`, traduccion: `емоційні провали` },
  { palabra: `La felicidad sigue sin llegar`, traduccion: `щастя так і не настає` },
  { palabra: `Factor infravalorado`, traduccion: `недооцінений чинник` },
  { palabra: `El desencanto`, traduccion: `розчарування` },
  { palabra: `La proliferación`, traduccion: `поширення, розростання` },
  { palabra: `Facilón`, traduccion: `надто спрощений, примітивний (від fácil)` },
  { palabra: `La autocompasión`, traduccion: `саможалість` },
  { palabra: `Repunte`, traduccion: `різкий підйом, сплеск` },
  { palabra: `El incremento`, traduccion: `збільшення` },
  { palabra: `La benevolencia`, traduccion: `доброзичливість, поблажливість` },
  { palabra: `Hacer hincapié`, traduccion: `робити наголос, акцентувати` },
  { palabra: `Restar apatía`, traduccion: `зменшувати апатію` }
]});

window.DELE_DATA.articleDecks.push({ id: 'peste', emoji: '🐖', titulo: 'Peste porcina', cards: [
  { palabra: `La peste (porcina)`, traduccion: `свиняча чума` },
  { palabra: `Jabalí (jabalíes)`, traduccion: `кабан (кабани)` },
  { palabra: `Un virus contagioso`, traduccion: `заразний вірус` },
  { palabra: `Transmitir a`, traduccion: `передавати комусь / заразити` },
  { palabra: `Desatar la alarma`, traduccion: `підняти тривогу` },
  { palabra: `Virus resistente`, traduccion: `стійкий вірус` },
  { palabra: `Productos procesados`, traduccion: `перероблені продукти` },
  { palabra: `Afectar a`, traduccion: `впливати на / уражати` },
  { palabra: `Fiebre`, traduccion: `гарячка` },
  { palabra: `Tos`, traduccion: `кашель` },
  { palabra: `Hemorragias`, traduccion: `кровотечі` },
  { palabra: `Estar erradicado`, traduccion: `бути викоріненим` },
  { palabra: `Consejero de Agricultura (cat. conseller)`, traduccion: `радник/міністр сільського господарства` },
  { palabra: `Contaminado (contaminar)`, traduccion: `заражений / забруднений (заражувати)` },
  { palabra: `Ingerido (ingerir)`, traduccion: `проковтнутий / спожитий (ковтати)` },
  { palabra: `Desperdicio`, traduccion: `відходи` },
  { palabra: `Desinfección`, traduccion: `дезінфекція` },
  { palabra: `Saneamiento`, traduccion: `санітарія / очищення` },
  { palabra: `Hallar`, traduccion: `виявити / знайти` },
  { palabra: `Dar positivo en las analíticas`, traduccion: `дати позитивний результат аналізів` },
  { palabra: `Sea cual sea el inicio`, traduccion: `яким би не було походження` },
  { palabra: `Aparición (aparecer)`, traduccion: `поява (з'являтися)` },
  { palabra: `Plaga`, traduccion: `пошесть / епідемія` },
  { palabra: `Animales salvajes`, traduccion: `дикі тварини` },
  { palabra: `Especies`, traduccion: `види` },
  { palabra: `Brote (de enfermedad)`, traduccion: `спалах (хвороби)` },
  { palabra: `Ser una fuente de infección`, traduccion: `бути джерелом інфекції` },
  { palabra: `Restos`, traduccion: `рештки` },
  { palabra: `Suponer riesgos`, traduccion: `становити ризики` },
  { palabra: `Productos de porcino`, traduccion: `свинарські продукти / продукція зі свинини` },
  { palabra: `Abastecimiento`, traduccion: `постачання / забезпечення` },
  { palabra: `Atajar la enfermedad`, traduccion: `зупинити / стримати хворобу` },
  { palabra: `Bioseguridad`, traduccion: `біобезпека` },
  { palabra: `Jabalíes que tengan vallado`, traduccion: `кабани, які утримуються за огорожею` },
  { palabra: `Evitar todo contacto`, traduccion: `уникати будь-якого контакту` },
  { palabra: `Impermeabilizar`, traduccion: `зробити непроникним / ізолювати` },
  { palabra: `Confinar a las granjas`, traduccion: `ізолювати у межах ферм` },
  { palabra: `Confinamiento`, traduccion: `ізоляція / карантин` },
  { palabra: `Silvestre`, traduccion: `дикий` },
  { palabra: `Propagación del virus`, traduccion: `поширення вірусу` },
  { palabra: `Poner en marcha`, traduccion: `запустити / розпочати` },
  { palabra: `Ganadería`, traduccion: `тваринництво` },
  { palabra: `Varapalo`, traduccion: `удар / важкий удар (переносно — «серйозний удар по галузі»)` }
]});

window.DELE_DATA.articleDecks.push({ id: 'burnout', emoji: '🧠', titulo: 'Burnout y rust out', cards: [
  { palabra: `Tomar/coger un descanso`, traduccion: `зробити перерву` },
  { palabra: `Los pendientes (del trabajo)`, traduccion: `невиконані робочі завдання / «хвости» по роботі` },
  { palabra: `Mejor rendimiento en el trabajo`, traduccion: `краща результативність на роботі` },
  { palabra: `Dado que`, traduccion: `оскільки` },
  { palabra: `El burn out (Síndrome de desgaste profesional)`, traduccion: `професійне вигорання` },
  { palabra: `El rust out (Síndrome de estancamiento profesional)`, traduccion: `емоційне «іржавіння» / занепад мотивації через монотонність` },
  { palabra: `Estresar / estrés / estresado / estresante`, traduccion: `стресувати / стрес / у стані стресу / стресогенний` },
  { palabra: `Si bien`, traduccion: `хоча` },
  { palabra: `Exacerbado`, traduccion: `загострений` },
  { palabra: `Distar`, traduccion: `відрізнятись / відмежовуватись` },
  { palabra: `Hacerse cargo de`, traduccion: `взяти на себе відповідальність за` },
  { palabra: `Según sea el caso`, traduccion: `залежно від ситуації` },
  { palabra: `Venerar`, traduccion: `звеличувати, боготворити` },
  { palabra: `Coincidir con`, traduccion: `збігатися з, мати спільну думку з` },
  { palabra: `Círculo vicioso`, traduccion: `замкнене коло` },
  { palabra: `Incesable`, traduccion: `невпинний` },
  { palabra: `Sentirse agotado`, traduccion: `відчувати виснаження` },
  { palabra: `No hacer más que`, traduccion: `тільки й робити, що…` },
  { palabra: `Sentirse angustiado`, traduccion: `відчувати тривогу / гнітючий стан` },
  { palabra: `Ceder el control`, traduccion: `поступитися контролем / віддати контроль` },
  { palabra: `Es más común en personas`, traduccion: `частіше трапляється у людей` },
  { palabra: `Hacer frente a`, traduccion: `протистояти, давати раду` },
  { palabra: `Emitir señales`, traduccion: `подавати сигнали` },
  { palabra: `Esparcimiento / ocio`, traduccion: `відпочинок, розваги, дозвілля` }
]});

window.DELE_DATA.articleDecks.push({ id: 'inmobiliaria', emoji: '🏘', titulo: 'Burbuja inmobiliaria', cards: [
  { palabra: `Ni rastro`, traduccion: `ані сліду` },
  { palabra: `Burbuja inmobiliaria`, traduccion: `ринкова (житлова) бульбашка` },
  { palabra: `Abrupto`, traduccion: `різкий, стрімкий, раптовий` },
  { palabra: `Estallido`, traduccion: `вибух` },
  { palabra: `Hay margen para`, traduccion: `є простір / можливість для` },
  { palabra: `Resonar`, traduccion: `відлунювати, звучати` },
  { palabra: `Al alza`, traduccion: `на підйомі, у зростанні` },
  { palabra: `Arma de doble filo`, traduccion: `палиця з двома кінцями` },
  { palabra: `Escasez`, traduccion: `дефіцит, нестача` },
  { palabra: `Deuda de los hogares`, traduccion: `заборгованість домогосподарств` },
  { palabra: `Al compás`, traduccion: `у ритмі, синхронно` },
  { palabra: `Prever`, traduccion: `передбачати, прогнозувати` },
  { palabra: `Pese a que`, traduccion: `попри те, що / хоча` },
  { palabra: `Enfriamiento en el mercado`, traduccion: `охолодження ринку` },
  { palabra: `Interanual`, traduccion: `міжрічний` },
  { palabra: `Elocuente`, traduccion: `красномовний, промовистий` },
  { palabra: `Loable`, traduccion: `гідний похвали, похвальний` },
  { palabra: `Asequibilidad`, traduccion: `доступність (у сенсі ціни)` },
  { palabra: `Desapalancamiento`, traduccion: `зменшення боргового навантаження` },
  { palabra: `Recesión`, traduccion: `рецесія, спад` },
  { palabra: `Corroborar`, traduccion: `підтверджувати, засвідчувати` },
  { palabra: `Morosidad`, traduccion: `прострочена заборгованість, неплатоспроможність` },
  { palabra: `Colchón financiero`, traduccion: `фінансова подушка / резерв` },
  { palabra: `Asemejarse`, traduccion: `бути схожим, нагадувати` },
  { palabra: `Venir de la mano`, traduccion: `супроводжуватися, іти разом із` },
  { palabra: `Propiciar un aumento`, traduccion: `сприяти зростанню / стимулювати підвищення` },
  { palabra: `Atisbar`, traduccion: `помічати, вловлювати (бачити ознаки)` },
  { palabra: `Ir a la zaga`, traduccion: `відставати, плестися позаду` },
  { palabra: `Tener reminiscencias`, traduccion: `мати відгомін / нагадувати щось` },
  { palabra: `Reversión repentina`, traduccion: `раптовий зворот / різкий розворот тенденції` },
  { palabra: `Superávit`, traduccion: `профіцит, перевищення доходів над витратами` }
]});

window.DELE_DATA.articleDecks.push({ id: 'longevidad', emoji: '💊', titulo: 'Suplementación y longevidad', cards: [
  { palabra: `La suplementación`, traduccion: `додавання харчових добавок` },
  { palabra: `Los suplementos`, traduccion: `добавки` },
  { palabra: `Jugar un papel clave`, traduccion: `відігравати ключову роль` },
  { palabra: `Jugar un papel decisivo`, traduccion: `відігравати вирішальну роль` },
  { palabra: `Enfoque holístico`, traduccion: `цілісний підхід` },
  { palabra: `Ahora bien`, traduccion: `втім / однак` },
  { palabra: `Por tanto`, traduccion: `отже / тому` },
  { palabra: `Reducir la edad biológica`, traduccion: `зменшити біологічний вік` },
  { palabra: `Ingerir (alimentos)`, traduccion: `вживати (їжу)` },
  { palabra: `Un régimen de`, traduccion: `режим / розпорядок` },
  { palabra: `La longevidad`, traduccion: `довголіття` },
  { palabra: `Más allá de`, traduccion: `поза межами / більше ніж` },
  { palabra: `La obsesión (por)`, traduccion: `одержимість (чимось)` },
  { palabra: `El envejecimiento`, traduccion: `старіння` },
  { palabra: `Envejecer`, traduccion: `старіти` },
  { palabra: `Celular`, traduccion: `клітинний` },
  { palabra: `Las células`, traduccion: `клітини` },
  { palabra: `El núcleo`, traduccion: `ядро` },
  { palabra: `La mitocondria`, traduccion: `мітохондрія` },
  { palabra: `Las alteraciones`, traduccion: `зміни / порушення` },
  { palabra: `Se manifiesta con`, traduccion: `проявляється (чимось)` },
  { palabra: `Las arrugas`, traduccion: `зморшки` },
  { palabra: `La pérdida de firmeza`, traduccion: `втрата пружності` },
  { palabra: `La caída del cabello`, traduccion: `випадіння волосся` },
  { palabra: `La aparición de vello`, traduccion: `поява волосся (на тілі/обличчі)` },
  { palabra: `Revertir (el envejecimiento)`, traduccion: `зворотити / призупинити старіння` },
  { palabra: `A día de hoy`, traduccion: `на сьогодні / наразі` },
  { palabra: `Ralentizar el proceso`, traduccion: `уповільнити процес` },
  { palabra: `Hay que tener claro`, traduccion: `треба чітко розуміти` },
  { palabra: `En el marco de`, traduccion: `у межах / у контексті` },
  { palabra: `La alimentación equilibrada`, traduccion: `збалансоване харчування` },
  { palabra: `Un estilo de vida saludable`, traduccion: `здоровий спосіб життя` },
  { palabra: `Ciertos`, traduccion: `певні` },
  { palabra: `Los nutrientes`, traduccion: `поживні речовини` },
  { palabra: `Oxidativo`, traduccion: `окислювальний` },
  { palabra: `Oxidar`, traduccion: `окислювати` },
  { palabra: `Oxidación`, traduccion: `окиснення` },
  { palabra: `El manejo del estrés`, traduccion: `управління стресом` },
  { palabra: `Todo siempre con cabeza`, traduccion: `все робити з розумом` },
  { palabra: `Monitoreo constante`, traduccion: `постійний моніторинг` },
  { palabra: `Evidenciar`, traduccion: `підтверджувати / демонструвати` },
  { palabra: `Evidencia`, traduccion: `доказ` },
  { palabra: `Basado en evidencia`, traduccion: `заснований на доказах` },
  { palabra: `Lo que sí podemos conseguir`, traduccion: `те, чого ми дійсно можемо досягти` },
  { palabra: `Los procesos degenerativos`, traduccion: `дегенеративні процеси` },
  { palabra: `Escudo protector`, traduccion: `захисний щит` },
  { palabra: `El hierro`, traduccion: `залізо` },
  { palabra: `Se corroe (corroer)`, traduccion: `кородує / іржавіє` },
  { palabra: `La corrosión`, traduccion: `корозія` },
  { palabra: `Preservar la salud`, traduccion: `зберігати здоров'я` },
  { palabra: `Favorecer`, traduccion: `сприяти` },
  { palabra: `Recalcar`, traduccion: `підкреслити / наголосити` },
  { palabra: `Apostar por`, traduccion: `робити ставку на / обирати` },
  { palabra: `Investigación robusta`, traduccion: `ґрунтовне дослідження` },
  { palabra: `A largo plazo`, traduccion: `у довгостроковій перспективі` },
  { palabra: `La medicina de precisión`, traduccion: `прецизійна (персоналізована) медицина` }
]});

window.DELE_DATA.articleDecks.push({ id: 'diogenes', emoji: '🗑️', titulo: 'Síndrome de Diógenes', cards: [
  { palabra: `Síndrome de Diógenes`, traduccion: `синдром Діогена` },
  { palabra: `Padecer (de) una enfermedad`, traduccion: `страждати на хворобу` },
  { palabra: `Trastorno`, traduccion: `розлад` },
  { palabra: `Cantidad ingente`, traduccion: `величезна кількість` },
  { palabra: `Objetos inservibles`, traduccion: `непридатні предмети` },
  { palabra: `Acumular`, traduccion: `накопичувати` },
  { palabra: `Almacenar`, traduccion: `зберігати` },
  { palabra: `Costar a alguien (le cuesta)`, traduccion: `комусь важко / дається з труднощами` },
  { palabra: `Desprenderse de algo`, traduccion: `позбутися чогось` },
  { palabra: `Saturación de información`, traduccion: `перенасичення інформацією` },
  { palabra: `Ralentización`, traduccion: `уповільнення` },
  { palabra: `Ansiedad`, traduccion: `тривога` },
  { palabra: `Angustia`, traduccion: `туга / тривожний стан` },
  { palabra: `Mero (mera idea)`, traduccion: `самий / лише (сама ідея)` },
  { palabra: `Estar repleto de`, traduccion: `бути переповненим` },
  { palabra: `Entrañar una necesidad`, traduccion: `передбачати / тягнути за собою потребу` }
]});

window.DELE_DATA.articleDecks.push({ id: 'genz', emoji: '😎', titulo: 'Generación Z y salud', cards: [
  { palabra: `Generación Z`, traduccion: `покоління Z` },
  { palabra: `Carbohidratos`, traduccion: `вуглеводи` },
  { palabra: `Tener en cuenta`, traduccion: `брати до уваги` },
  { palabra: `Carbohidratos de absorción rápida`, traduccion: `вуглеводи швидкого засвоєння` },
  { palabra: `Tener tripa y lorzas`, traduccion: `мати живіт і жирові складки на боках` },
  { palabra: `Mileurista`, traduccion: `людина з низькою зарплатою (близько 1000 € на місяць)` },
  { palabra: `Suplementarse`, traduccion: `приймати харчові добавки` },
  { palabra: `Adaptógenos`, traduccion: `адаптогени` },
  { palabra: `Venerar`, traduccion: `шанувати` },
  { palabra: `Doctrina estoica`, traduccion: `стоїчна доктрина (вчення, що закликає приймати події спокійно й зосереджуватись на тому, що можна контролювати)` },
  { palabra: `Hedonismo epicúreo`, traduccion: `епікурейський гедонізм (підхід, що вбачає щастя в помірних насолодах та душевному спокої)` },
  { palabra: `Enfermedades de transmisión sexual`, traduccion: `хвороби, що передаються статевим шляхом` },
  { palabra: `Gestión del estrés`, traduccion: `управління стресом` },
  { palabra: `Ser diestro en`, traduccion: `бути вправним у` },
  { palabra: `Someterse a`, traduccion: `піддаватися чомусь / проходити процедуру` },
  { palabra: `Ojeras`, traduccion: `темні кола під очима` },
  { palabra: `Disimular`, traduccion: `приховувати` },
  { palabra: `Poco dados a la ironía`, traduccion: `мало схильні до іронії` },
  { palabra: `Cuádriceps definidos`, traduccion: `рельєфні квадрицепси` },
  { palabra: `Esculpir el cuerpo`, traduccion: `вирізьблювати (формувати) тіло` },
  { palabra: `Rostro terso`, traduccion: `гладке обличчя` },
  { palabra: `Sin rastro`, traduccion: `без сліду` },
  { palabra: `Cuando vienen mal dadas`, traduccion: `коли обставини складаються погано` },
  { palabra: `Airear`, traduccion: `виносити на загал / розголошувати` },
  { palabra: `Efectos nocivos`, traduccion: `шкідливі наслідки` },
  { palabra: `Poner en jaque`, traduccion: `поставити під загрозу / загнати в кут` },
  { palabra: `Normalicemos`, traduccion: `давайте зробимо нормою` },
  { palabra: `Cancelar los planes`, traduccion: `скасовувати плани` },
  { palabra: `Ser un planazo`, traduccion: `бути чудовою ідеєю для проведення часу` },
  { palabra: `Cara a cara`, traduccion: `віч-на-віч` },
  { palabra: `Sobrepasar`, traduccion: `перевищувати / переступати межу` },
  { palabra: `Caer en picado`, traduccion: `різко впасти / стрімко знизитися` },
  { palabra: `Auspiciar`, traduccion: `сприяти / покровительствувати` },
  { palabra: `OMS`, traduccion: `ВООЗ (Всесвітня організація охорони здоров'я)` },
  { palabra: `Dar sus frutos`, traduccion: `давати результати / приносити плоди` },
  { palabra: `Por defecto`, traduccion: `за замовчуванням` },
  { palabra: `Abstinencia`, traduccion: `утримання / абстиненція` },
  { palabra: `Lucidez`, traduccion: `ясність розуму` },
  { palabra: `Talón de Aquiles`, traduccion: `ахіллесова п'ята` },
  { palabra: `Estar a gusto`, traduccion: `почуватися комфортно` },
  { palabra: `A toda costa`, traduccion: `будь-якою ціною` },
  { palabra: `Corroborar`, traduccion: `підтвердити` },
  { palabra: `Arrastrar`, traduccion: `тягнути / затягувати (у щось) / знищити` },
  { palabra: `Rendimiento cognitivo`, traduccion: `когнітивна працездатність` },
  { palabra: `Calistenia`, traduccion: `каллістеніка (вправи з власною вагою тіла для розвитку сили й витривалості)` },
  { palabra: `Burpees`, traduccion: `берпі (інтенсивна вправа: присідання, віджимання і стрибок)` },
  { palabra: `Revancha`, traduccion: `реванш` },
  { palabra: `Machaque`, traduccion: `виснажливе тренування / знос` },
  { palabra: `Viejunos`, traduccion: `старпери / старомодні люди` }
]});

window.DELE_DATA.articleDecks.push({ id: 'sesgos', emoji: '📝', titulo: 'Ilusión de frecuencia y sesgos', cards: [
  { palabra: `Ilusión de frecuencia`, traduccion: `ілюзія частоти` },
  { palabra: `Tener raíces en`, traduccion: `мати коріння в` },
  { palabra: `No parar de hacer algo`, traduccion: `не переставати щось робити` },
  { palabra: `Percatarse de`, traduccion: `усвідомити / помітити` },
  { palabra: `Prestar atención a`, traduccion: `звертати увагу на` },
  { palabra: `Volverse importante`, traduccion: `ставати важливим` },
  { palabra: `Llevar a`, traduccion: `призводити до` },
  { palabra: `Ganar reconocimiento`, traduccion: `здобути визнання` },
  { palabra: `Acabar haciendo algo`, traduccion: `зрештою зробити щось` },
  { palabra: `Sesgo de confirmación`, traduccion: `підтверджувальне упередження (тенденція шукати інформацію, що підтверджує власні переконання)` },
  { palabra: `Acuñar el término`, traduccion: `ввести термін / започаткувати поняття` },
  { palabra: `Atención selectiva`, traduccion: `вибіркова увага` },
  { palabra: `Puesto que`, traduccion: `оскільки` },
  { palabra: `Vínculos / vincular / estar vinculado`, traduccion: `зв'язки / пов'язувати / бути пов'язаним` },
  { palabra: `Capacidad de percepción`, traduccion: `здатність до сприйняття` },
  { palabra: `Atender a un estímulo`, traduccion: `реагувати на стимул` },
  { palabra: `Captar`, traduccion: `сприймати / вловлювати` },
  { palabra: `Sesgos cognitivos`, traduccion: `когнітивні упередження` },
  { palabra: `Estrés postraumático`, traduccion: `посттравматичний стрес` }
]});

window.DELE_DATA.articleDecks.push({ id: 'mitos', emoji: '🥗', titulo: 'Mitos de nutrición', cards: [
  { palabra: `Estar plagado de`, traduccion: `бути переповненим (чимось), бути насиченим` },
  { palabra: `Los mitos`, traduccion: `міфи` },
  { palabra: `Estar perpetuado en la historia (perpetuar)`, traduccion: `бути закарбованим в історії` },
  { palabra: `Fomentar`, traduccion: `заохочувати, сприяти` },
  { palabra: `Los bulos`, traduccion: `фейки, дезінформація` },
  { palabra: `Propagarse (propaganda)`, traduccion: `поширюватися` },
  { palabra: `Una tanda de`, traduccion: `серія, партія (чогось)` },
  { palabra: `La nutrición`, traduccion: `харчування` },
  { palabra: `En ayunas`, traduccion: `натщесерце` },
  { palabra: `La orina (orinar)`, traduccion: `сеча` },
  { palabra: `El esmalte dental`, traduccion: `зубна емаль` },
  { palabra: `De paso`, traduccion: `заодно, між іншим` },
  { palabra: `La dieta omnívora`, traduccion: `всеїдна дієта` },
  { palabra: `De por sí`, traduccion: `саме по собі` },
  { palabra: `Las enfermedades cardiovasculares`, traduccion: `серцево-судинні захворювання` },
  { palabra: `Los carbohidratos`, traduccion: `вуглеводи` },
  { palabra: `Ingerir un alimento`, traduccion: `споживати їжу` },
  { palabra: `Ingesta`, traduccion: `споживання (їжі, рідини)` },
  { palabra: `Depurar el cuerpo`, traduccion: `очищати організм` },
  { palabra: `El hígado`, traduccion: `печінка` },
  { palabra: `Los riñones`, traduccion: `нирки` },
  { palabra: `Los pulmones`, traduccion: `легені` },
  { palabra: `El timo`, traduccion: `шахрайство` }
]});

// =============================================================
// FRASES HECHAS DE SEMANA SANTA (se añaden al mazo de Expresiones)
// =============================================================

window.DELE_DATA.idioms.push(
  { expresion: `Ser un Judas`, traduccion: `бути зрадником`, significado: `persona que traiciona o actúa con falsedad (por Judas Iscariote)`, ejemplo: `Carlos es un Judas, no te fíes de él.` },
  { expresion: `Llorar como una Magdalena`, traduccion: `дуже сильно плакати`, significado: `llorar desconsoladamente (por María Magdalena)`, ejemplo: `No ha dejado de llorar como una Magdalena desde ayer.` },
  { expresion: `Meter el dedo en la llaga`, traduccion: `тиснути на болюче місце`, significado: `insistir en un tema doloroso o molesto para alguien`, ejemplo: `Ya sé que me equivoqué, no metas el dedo en la llaga.` },
  { expresion: `La procesión va por dentro`, traduccion: `людина страждає, але цього не показує`, significado: `sufrir por dentro aunque por fuera se aparente estar bien`, ejemplo: `Dice que está bien, pero la procesión va por dentro.` },
  { expresion: `Más contento que unas pascuas`, traduccion: `дуже щасливий`, significado: `estar muy contento y alegre`, ejemplo: `Está más contenta que unas pascuas hoy.` },
  { expresion: `Estar pasando un calvario`, traduccion: `переживати дуже важкий період`, significado: `atravesar una etapa llena de sufrimiento (por el Monte Calvario)`, ejemplo: `Últimamente estamos pasando un calvario.` },
  { expresion: `De Pascuas a Ramos`, traduccion: `дуже рідко`, significado: `muy de vez en cuando, cada mucho tiempo`, ejemplo: `No nos vemos nunca, o sea, de Pascuas a Ramos.` },
  { expresion: `Lavarse las manos`, traduccion: `зняти з себе відповідальність`, significado: `desentenderse de un problema (por Poncio Pilato)`, ejemplo: `Yo me lavo las manos, no es mi problema.` },
  { expresion: `Ser una cruz`, traduccion: `бути тягарем`, significado: `ser algo muy difícil o una carga que hay que soportar`, ejemplo: `Este trabajo es mi cruz.` },
  { expresion: `Estar hecho un Cristo`, traduccion: `бути в жахливому стані`, significado: `estar muy mal, sucio, cansado o maltrecho`, ejemplo: `Después del entrenamiento estaba hecho un Cristo.` }
);

// =============================================================
// NOTAS DE USO / COLOCACIONES (calcos frecuentes) — "Visto en clase"
// =============================================================

window.DELE_DATA.usageNotes = [
  {
    palabra: `tendencia`,
    error: `Esta canción está en las tendencias. (calco)`,
    alternativas: [
      `Esta canción es tendencia.`,
      `Esta canción está de moda.`,
      `Esta canción se ha vuelto viral.`
    ],
    definicion: `tendencia — тенденція, тренд: будь-яка стійка зміна, напрямок розвитку або закономірність.`,
    colocaciones: [
      { forma: `tendencia (dato / gráfico)`, ua: `тенденція`, ejemplo: `Las tendencias de consumo han cambiado mucho en los últimos años.`, ejemploUa: `Споживчі тенденції дуже змінилися за останні роки. (ідеально для опису графіку)` },
      { forma: `marcar tendencia`, ua: `задавати тренд`, ejemplo: `Los influencers suelen marcar tendencia en el mundo de la nutrición.`, ejemploUa: `Інфлюенсери часто формують тенденції у сфері харчування.` },
      { forma: `seguir una tendencia`, ua: `слідувати тренду`, ejemplo: `No me gusta seguir tendencias; prefiero tener mi propio estilo.`, ejemploUa: `Я не люблю гнатися за трендами, мені більше подобається мати власний стиль.` },
      { forma: `las últimas tendencias`, ua: `останні тренди`, ejemplo: `Este artículo analiza las últimas tendencias demográficas del país.`, ejemploUa: `Ця стаття присвячена аналізу останніх змін у демографічній ситуації країни.` },
      { forma: `ser tendencia`, ua: `бути в тренді`, ejemplo: `Ese vídeo es tendencia en varios países.`, ejemploUa: `Це відео в тренді в кількох країнах.` },
      { forma: `tendencia a + infinitivo`, ua: `тенденція + інфінітив`, ejemplo: `Existe una clara tendencia a utilizar la inteligencia artificial en el ámbito educativo.`, ejemploUa: `Існує чітка тенденція використовувати штучний інтелект у сфері освіти.` }
    ]
  }
];

// =============================================================
// MULETILLAS PARA GANAR TIEMPO EN LA PRUEBA ORAL
// =============================================================

window.DELE_DATA.fillerPhrases = [
  { es: `A ver…`, ua: `Ну, подивимось…` },
  { es: `Déjame pensar…`, ua: `Дай подумати…` },
  { es: `Pues…`, ua: `Ну…` },
  { es: `Bueno…`, ua: `Ну / отже…` },
  { es: `Es una buena pregunta…`, ua: `Це хороше запитання` },
  { es: `Nunca me lo había planteado así…`, ua: `Я ніколи не дивився(-лась) на це так` },
  { es: `Diría que…`, ua: `Я б сказав(-ла), що…` },
  { es: `Desde mi punto de vista…`, ua: `З моєї точки зору…` },
  { es: `Si no me equivoco…`, ua: `Якщо я не помиляюсь…` },
  { es: `No soy muy experto, sin embargo, me parece que…`, ua: `Я не дуже розбираюсь у цій темі, проте я вважаю, що…` }
];
